...
function setupNewsSlider() {
    ...
    if (news.type === 'row' && document.documentElement.offsetWidth > 600) {
        ...
        for (var i = 0; i < news.items.length; i+=4) {
            ...
            // var html2 = '<li class="splide__slide news__slide">' + news.items[i+1].outerHTML + '</li>';
            // var html3 = '<li class="splide__slide news__slide">' + news.items[i+2].outerHTML + '</li>';
            // var html4 = '<li class="splide__slide news__slide">' + news.items[i+3].outerHTML + '</li>';
...
//     <a class="news-grid__item" href="#">
    //     <div class="news-grid__content">
    //         <div class="news-grid__title">Почему мы набираем вес зимой?</div>
    //         <div class="news-grid__subtitle">Прогулки на свежем воздухе нам нужны для поддержания веса в...</div>
    //     </div>
    //     <div class="news-grid__img" style="background-image:url(assets/img/content/news/1.png);">
    //         <!-- <img src="assets/img/content/news/1.png" alt="Новость"> -->
    //     </div>
    // </a>
